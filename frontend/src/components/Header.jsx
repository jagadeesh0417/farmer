        ...
        <div className="lg:hidden fixed inset-0 z-50 bg-white flex flex-col">
          ...
          <div className="flex-1 overflow-y-auto p-5 space-y-1 font-menu">
            ...
            <div className="pt-4 px-4">
              <a href="https://wa.me/919709704563?text=Hello%20HaiFarmer" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2 bg-green-600 text-white px-4 py-3 text-sm font-semibold hover:bg-green-700 transition-colors">
