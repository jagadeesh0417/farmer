export default function MobileCheckoutBar({ showTotal, totalLabel, total, children }) {
  return (
    <div className="fixed inset-x-0 bottom-0 z-[45] border-t border-[#E5EDD8] bg-white/95 backdrop-blur px-4 py-3 pb-[max(0.75rem,env(safe-area-inset-bottom))] lg:hidden shadow-[0_-4px_20px_rgba(0,0,0,0.06)]">
