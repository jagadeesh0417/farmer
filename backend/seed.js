...
const PRODUCTS = [
  {
    name: 'Wild Honey', slug: 'wild-honey',
    ...
    categoryName: 'Natural Sweeteners', basePrice: 1199, discountPercent: 0, isFeatured: true, isNewArrival: true, displayOrder: 1,
    variants: [
  ...
  },
  {
    ...
    categoryName: 'Natural Sweeteners', basePrice: 175, discountPercent: 0, isNewArrival: true, displayOrder: 2,
    variants: [
  ...
  },
  {
    ...
    categoryName: 'Salt & Essentials', basePrice: 120, discountPercent: 0, displayOrder: 3,
    variants: [
  ...
  {
    name: 'Alasandhalu — Black Chickpeas', slug: 'alasandhalu-black-chickpeas',
    ...
    categoryName: 'Lentils & Beans', basePrice: 279, discountPercent: 0, isFeatured: true, displayOrder: 4,
    variants: [
  ...
  {
    name: 'Adavi Nalla Bobbarlu — Black Eyed Peas', slug: 'adavi-nalla-bobbarlu',
    ...
    categoryName: 'Lentils & Beans', basePrice: 279, discountPercent: 0, displayOrder: 5,
    variants: [
      { name: '1kg Pack', weightLabel: '1kg', price: 279, stock: 100, unit: 'kg' },
      { name: '500g Pack', weightLabel: '500g', price: 149, stock: 100, unit: 'kg' },
    ],
  ...
  {
    name: 'Red Rajma — Red Kidney Beans', slug: 'red-rajma',
    ...
    categoryName: 'Lentils & Beans', basePrice: 279, discountPercent: 0, displayOrder: 6,
    variants: [
      { name: '1kg Pack', weightLabel: '1kg', price: 279, stock: 100, unit: 'kg' },
      { name: '500g Pack', weightLabel: '500g', price: 149, stock: 100, unit: 'kg' },
    ],
  ...
  {
    name: 'White Rajma — White Kidney Beans', slug: 'white-rajma',
    ...
    categoryName: 'Lentils & Beans', basePrice: 279, discountPercent: 0, displayOrder: 7,
    variants: [
      { name: '1kg Pack', weightLabel: '1kg', price: 279, stock: 100, unit: 'kg' },
      { name: '500g Pack', weightLabel: '500g', price: 149, stock: 100, unit: 'kg' },
    ],
  ...
  {
    name: 'Nattu Pesalu — Green Gram', slug: 'nattu-pesalu-green-gram',
    ...
    categoryName: 'Lentils & Beans', basePrice: 249, discountPercent: 0, displayOrder: 8,
    variants: [
  ...
  {
    name: 'Konda Kandhi Pappu — Pigeon Pea', slug: 'konda-kandhi-pappu',
    ...
    categoryName: 'Lentils & Beans', basePrice: 289, discountPercent: 0, displayOrder: 9,
    variants: [
  ...
  {
    name: 'Forest Tamarind — Chintapandu', slug: 'forest-tamarind',
    ...
    categoryName: 'Spices & Seasonings', basePrice: 289, discountPercent: 0, displayOrder: 10,
    variants: [
  ...
  {
    name: 'Agency Karam — Red Chili Powder', slug: 'agency-karam',
    ...
    categoryName: 'Spices & Seasonings', basePrice: 399, discountPercent: 0, isFeatured: true, isNewArrival: true, displayOrder: 11,
    variants: [
  ...
  {
    name: 'Tribal Pasupu — Turmeric Powder', slug: 'tribal-pasupu',
    ...
    categoryName: 'Spices & Seasonings', basePrice: 399, discountPercent: 0, isFeatured: true, isNewArrival: true, displayOrder: 12,
    variants: [
      { name: '1kg Pack', weightLabel: '1kg', price: 399, stock: 50, unit: 'kg' },
      { name: '500g Pack', weightLabel: '500g', price: 219, stock: 50, unit: 'kg' },
    ],
  ...
  {
    name: 'Avalu — Mustard Seeds', slug: 'avalu-mustard-seeds',
    ...
    categoryName: 'Spices & Seasonings', basePrice: 180, discountPercent: 0, displayOrder: 13,
    variants: [
  ...
  {
    name: 'Miryalu — Black Pepper', slug: 'miryalu-black-pepper',
    ...
    categoryName: 'Spices & Seasonings', basePrice: 349, discountPercent: 0, displayOrder: 14,
    variants: [
  ...
  {
    name: 'Nalla Minumulu — Black Gram (Urad Dal)', slug: 'nalla-minumulu-urad-dal',
    ...
    categoryName: 'Lentils & Beans', basePrice: 279, discountPercent: 0, displayOrder: 15,
    variants: [
  ...
  {
    name: 'Tella Bobbarlu — White Peas', slug: 'tella-bobbarlu-white-peas',
    ...
    categoryName: 'Lentils & Beans', basePrice: 259, discountPercent: 0, displayOrder: 16,
    variants: [
  ...
  {
    name: 'Arikalu — Ragi (Finger Millet)', slug: 'arikalu-ragi-finger-millet',
    ...
    categoryName: 'Millets', basePrice: 229, discountPercent: 0, isNewArrival: true, displayOrder: 17,
    variants: [
  ...
  {
    name: 'Samalu — Little Millet', slug: 'samalu-little-millet',
    ...
    categoryName: 'Millets', basePrice: 249, discountPercent: 0, displayOrder: 18,
    variants: [
  ...
  {
    name: 'Korralu — Foxtail Millet', slug: 'korralu-foxtail-millet',
    ...
    categoryName: 'Millets', basePrice: 249, discountPercent: 0, displayOrder: 19,
    variants: [
      { name: '1kg Pack', weightLabel: '1kg', price: 249, stock: 50, unit: 'kg' },
      { name: '500g Pack', weightLabel: '500g', price: 139, stock: 50, unit: 'kg' },
    ],
  ...
  {
    name: 'Tella Jonnalu — White Sorghum (Jowar)', slug: 'tella-jonnalu-white-sorghum',
    ...
    categoryName: 'Millets', basePrice: 219, discountPercent: 0, displayOrder: 20,
    variants: [
  ...
  {
    name: 'Erra Jonnalu — Red Sorghum', slug: 'erra-jonnalu-red-sorghum',
    ...
    categoryName: 'Millets', basePrice: 239, discountPercent: 0, displayOrder: 21,
    variants: [
  ...
  {
    name: 'Sajjalu — Pearl Millet (Bajra)', slug: 'sajjalu-pearl-millet-bajra',
    ...
    categoryName: 'Millets', basePrice: 219, discountPercent: 0, displayOrder: 22,
    variants: [
      { name: '1kg Pack', weightLabel: '1kg', price: 219, stock: 50, unit: 'kg' },
      { name: '500g Pack', weightLabel: '500g', price: 119, stock: 50, unit: 'kg' },
    ],
  ...
  {
    name: 'Sprouted Ragi — Mola Arikalu', slug: 'sprouted-ragi-mola-arikalu',
    ...
    categoryName: 'Millets', basePrice: 249, discountPercent: 0, isNewArrival: true, displayOrder: 23,
    variants: [
      { name: '1kg Pack', weightLabel: '1kg', price: 249, stock: 50, unit: 'kg' },
      { name: '500g Pack', weightLabel: '500g', price: 139, stock: 50, unit: 'kg' },
    ],
...
const COMBOS = [
  {
    ...
    isCombo: true, discountPercent: 6,
    itemSlugs: [
  ...
  },
  {
    ...
    isCombo: true, discountPercent: 5,
    itemSlugs: [
      { slug: 'agency-karam', variantName: '500g Pack', quantity: 1 },
      { slug: 'tribal-pasupu', variantName: '500g Pack', quantity: 1 },
      { slug: 'forest-tamarind', variantName: '500g Pack', quantity: 1 },
...
const seedOrganic = async () => {
  ...
  for (const prod of ORGANIC_PRODUCTS) {
    ...
    const data = { ...prod, category: cat ? cat._id : undefined, categoryName: cat ? undefined : prod.categoryName }
    const existing = await Product.findOne({ slug: prod.slug })
    if (existing) await Product.findOneAndUpdate({ slug: prod.slug }, data)
    else await Product.create(data)
  }
  console.log(`  ✓ ${ORGANIC_PRODUCTS.length} organic products`)
  ...
  for (const combo of ORGANIC_COMBOS) {
    ...
    if (items.length > 0) await Bundle.create({
      name: combo.name, description: combo.description, isCombo: combo.isCombo,
      discountPercent: combo.discountPercent, items,
    })
  }
  console.log(`  ✓ ${ORGANIC_COMBOS.length} organic combos`)
}
...
const seedOriginal = async () => {
  ...
  console.log(`  ✓ ${CATEGORIES.length} original categories`)
  ...
  console.log(`  ✓ ${PRODUCTS.length} original products`)
  ...
  console.log(`  ✓ ${COMBOS.length} original combos`)
}
...
const seed = async () => {
  ...
  if (adminExists) {
    ...
    console.log('Admin updated: kakinadahomefoods@gmail.com / admin123')
  } else {
    await User.create({ email: 'kakinadahomefoods@gmail.com', password: 'admin123', fullName: 'HAiFarmer Admin', role: 'admin' })
    console.log('Admin created: kakinadahomefoods@gmail.com / admin123')
  }

  const settingsExists = await SiteSetting.findOne()
  if (!settingsExists) { await SiteSetting.create({}); console.log('Default settings created') }
  else { console.log('Settings already exist') }

  console.log('\n--- Original Products ---')
  await seedOriginal()

  console.log('\n--- Organic (Organic India-style) Products ---')
  await seedOrganic()

  const prodCount = await Product.countDocuments()
  const comboCount = await Bundle.countDocuments({ isCombo: true })
  const catCount = await Category.countDocuments()
  await mongoose.disconnect()
  console.log('\nSeed complete — %d products, %d combos across %d categories', prodCount, comboCount, catCount)
  process.exit(0)
}

seed().catch(err => { console.error(err.message); mongoose.disconnect().finally(() => process.exit(1)) })
